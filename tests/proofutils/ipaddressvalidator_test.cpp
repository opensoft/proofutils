...
INSTANTIATE_TEST_CASE_P(IpAdrressTestParameters, IpAddressValidationTest,
                        testing::Values(TestTuple("128.1.1.1", IpAddressValidator::Acceptable),
...
INSTANTIATE_TEST_CASE_P(SubnetMaskTestParameters, SubnetMaskValidationTest,
                        testing::Values(TestTuple("128.0.0.0", IpAddressValidator::Acceptable),
